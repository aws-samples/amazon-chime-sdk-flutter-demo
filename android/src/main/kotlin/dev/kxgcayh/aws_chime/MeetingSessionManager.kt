...
object MeetingSessionManager {
    ...
    private val NULL_MEETING_SESSION_RESPONSE: MethodChannelResult = MethodChannelResult(false, ResponseEnum.MEETING_SESSION_IS_NULL)
    ...
    fun startMeeting(
        ...
        return MethodChannelResult(true, ResponseEnum.CREATE_MEETING_SUCCESS)
    }
    ...
    fun stop(): MethodChannelResult {
        ...
        removeObservers()
        meetingSession = null
        return MethodChannelResult(true, ResponseEnum.MEETING_STOPPED_SUCCESSFULLY)
    }
